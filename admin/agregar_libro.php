...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($titulo) || empty($autor) || empty($anio_publicacion) || empty($estado) || empty($categoria_id)) {
        ...
        $sql = "INSERT INTO libros (titulo, autor, anio_publicacion, estado, categoria_id, descripcion)
                VALUES (:titulo, :autor, :anio_publicacion, :estado, :categoria_id, :descripcion)";
